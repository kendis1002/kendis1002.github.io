...
export default function BlogCard({ post }: BlogCardProps) {
  ...
  return (
    <div className="shadow-feature-card group relative rounded-xl px-4 py-4">
      <div
        className="pointer-events-none absolute inset-0 rounded-[20px] opacity-100 shadow-[0_-1px_0] ring-[0.2px] shadow-gray-200/20 ring-gray-200 dark:shadow-gray-400/20 dark:ring-gray-400"
        aria-hidden="true"
      />
